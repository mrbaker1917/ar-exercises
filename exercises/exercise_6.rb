...
@store1.employees.create(first_name: "Baker", last_name: "Mark", hourly_rate: 50)
@store1.employees.create(first_name: "Beverley", last_name: "Andre", hourly_rate: 40)
@store2.employees.create(first_name: "Ali", last_name: "Mustafa", hourly_rate: 50)
@store2.employees.create(first_name: "Korver", last_name: "Kyle", hourly_rate: 40)
@store2.employees.create(first_name: "Foster", last_name: "John", hourly_rate: 70)
